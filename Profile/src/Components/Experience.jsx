...
export default function Experience() {
  ...
  <div style={{ width: "100%", paddingTop: "0.75rem", maxWidth: "18rem", margin: "auto", padding: "0" }}>
    <div style={{ position: "relative", color: "#4a5568", fontFamily: "sans-serif", fontSize: "0.875rem", fontWeight: "bold" }}>
      {/* ========== vertical line running through the middle ========== */}
      <div style={{ display: "none", position: "absolute", width: "1px", backgroundColor: "#667eea", height: "100%", left: "50%", transform: "translateX(-50%)" }}></div>
